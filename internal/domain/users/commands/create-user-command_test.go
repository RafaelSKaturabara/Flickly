...
func setupMockServices(mockRepo *MockUserRepository, mockMediator *MockMediator) inversionofcontrol.IServiceCollection {
	serviceCollection := inversionofcontrol.NewServiceCollection()
	
	// Registrar o mock do repositório
	inversionofcontrol.AddService[repositories.IUserRepository](serviceCollection, mockRepo)
	
	// Registrar o mock do mediator
	inversionofcontrol.AddService[mediator.Mediator](serviceCollection, mockMediator)
